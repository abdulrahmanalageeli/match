...
- إذا كان هناك أي تطابق أو تكامل واضح في جانبين أو أكثر (2+): أعطِ 13-15 نقطة. كن سخيًا جدًا هنا.
- إذا كان هناك تطابق أو تكامل في جانب واحد على الأقل (1+): أعطِ 10-12 نقطة.
- إذا كانت الإجابات عامة ولكن لا يوجد تعارض واضح: أعطِ 7-9 نقاط.
- فقط في حالة وجود تعارض بسيط في بعض الجوانب: 4-6 نقاط.
- فقط في حالة التعارض الواضح في معظم الجوانب: 0-3 نقاط.
