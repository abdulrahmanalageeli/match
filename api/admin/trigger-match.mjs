...
- الهوايات والاهتمامات والشغف
- الذوق الموسيقي والفني
- تفضيل المحادثات العميقة أم الخفيفة
- كيف يصفهم الأصدقاء
- كيف يصفون أصدقائهم

**أولوية خاصة للشغف المشترك**: ركز بقوة على الشغف والاهتمامات العميقة. الشغف المشترك أهم من التوافق السطحي.

مبادئ التقييم المتساهل والواسع:
1. **الشغف والاهتمامات المشتركة (أولوية عليا)**: 
   - شغف مشترك كامل (نفس الهواية/الاهتمام بالضبط) = درجة عالية جداً (14-15)
   - شغف مشترك جزئي (نفس المجال لكن أنشطة مختلفة) = درجة عالية (12-13)
   - اهتمامات متكاملة (تكمل بعضها البعض) = درجة جيدة (9-11)
   - مثال: كلاهما يحب "القراءة" أو "السفر" أو "الرياضة" أو "الطبخ" = توافق استثنائي

2. **التوافق الموسيقي الواسع**: اعتبر أي موسيقى عربية متوافقة مع بعضها، وأي موسيقى غربية متوافقة مع بعضها. نفس النوع الموسيقي = درجة عالية

3. **أسلوب نهاية الأسبوع**: 
   - نفس النشاط المفضل = درجة عالية جداً
   - أنشطة متكاملة = درجة جيدة
   - أنشطة مختلفة تماماً = درجة متوسطة (توازن)

4. **الصفات الشخصية المكملة**: ركز على التكامل والتوازن، لكن الشغف المشترك أهم

5. **المحادثات العميقة**: نفس التفضيل = درجة أعلى، تفضيلات مختلفة = توازن

6. **التفاؤل في التقييم**: ابحث عن أي شغف مشترك أولاً، ثم نقاط التوافق الأخرى

قواعد التقييم المركزة على الشغف:
- شغف مشترك كامل + توافق في جوانب أخرى: أعطِ 14-15 نقطة (استثنائي)
- شغف مشترك كامل فقط: أعطِ 12-13 نقطة (ممتاز)
- شغف مشترك جزئي + توافق في جوانب أخرى: أعطِ 11-12 نقطة (جيد جداً)
- توافق في جانبين أو أكثر بدون شغف مشترك: أعطِ 9-10 نقاط (جيد)
- توافق في جانب واحد فقط: أعطِ 6-8 نقاط (متوسط)
- لا يوجد توافق واضح: أعطِ 3-5 نقاط (ضعيف)
- تعارض واضح في معظم الجوانب: أعطِ 0-2 نقطة (غير متوافق)

كن متفائلاً ومتساهلاً جدًا! ابحث عن أي شرارة محتملة وامنحها درجة عالية. الهدف هو تشجيع التواصل، وليس الكمال.
