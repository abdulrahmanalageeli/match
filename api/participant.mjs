...
اكتب رسالة (60-90 كلمة) بلهجة سعودية بيضاء، بأسلوب غامض وسينمائي يشبه الإثارة والتشويق. شروط الرسالة:

1. ابدأ باسمه "${firstName}" بطريقة هادئة وغامضة (كأنك تعرف شيئاً هو لا يعرفه)
2. استخدم معلومة واحدة من بياناته (هواية أو شخصية) بطريقة تثير الفضول — كأنها مفتاح لشيء أكبر
3. لمّح بأن الفعالية تخفي شيئاً غير متوقع (بدون كشف أي تفاصيل)
4. اختم بسؤال قصير أو جملة تشوّقه وتخليه يتساءل "وش راح يصير؟"
...
الهدف: يقرأها ${firstName} ويحس بالتشويق ويقول "وش القصة؟ حبيت أعرف!"`
