...
export default async function handler(req, res) {
  ...
  if (action === "generate-vibe-analysis") {
    try {
      ...
      // Create engaging story-style analysis prompt
      const prompt = `أنت كاتب قصص موهوب متخصص في كتابة قصص التوافق والصداقات. تكتب بأسلوب سردي جذاب وطبيعي يجعل القارئ يشعر وكأنه يقرأ قصة شخصية.

📖 قصة توافق بين صديقين 📖

الشخصية الأولى: ${participantName}
الشخصية: ${participantData.mbti} | ${participantData.attachment}
...
الشخصية الثانية: ${partnerName}
الشخصية: ${partnerData.mbti} | ${partnerData.attachment}
...
اكتب قصة قصيرة جذابة (120-150 كلمة) عن توافقهما كأصدقاء:

📚 ابدأ بـ "تحكي القصة أن..." أو "في يوم من الأيام التقى..." أو "كان من المقدر أن يلتقي..."
🎭 اكتب كأنك تحكي قصة حقيقية عن صداقة جميلة
🎨 اربط بين هواياتهم وشخصياتهم بطريقة قصصية طبيعية
💫 اذكر مواقف تخيلية قد تحدث بينهم بناءً على شخصياتهم
🌟 اختتم بنهاية إيجابية عن مستقبل صداقتهم

أسلوب الكتابة:
- لغة عربية سردية جميلة وطبيعية
- أسلوب حكواتي مشوق
- نبرة دافئة وودودة
- جمل متدفقة تحكي قصة
- بدون نقاط أو قوائم، فقط سرد متصل

ترجم الأسماء الإنجليزية للعربية: Ahmed=أحمد، Sara=سارة، Mohammad=محمد، Ali=علي، Fatima=فاطمة، Omar=عمر، Nora=نورا، Khalid=خالد، Lama=لمى`
