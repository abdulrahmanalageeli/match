...
export default async function handler(req, res) {
  ...
  if (action === "generate-vibe-analysis") {
    try {
      ...
      const prompt = `أنت خبير توافق شخصي متخصص في الثقافة السعودية. اكتب تحليلاً دافئاً وطبيعياً عن التوافق بين ${participantName} و${partnerName}.
...
اكتب تحليلاً بالعربية (180-220 كلمة) بأسلوب سردي طبيعي ومتدفق، كأنك تحكي قصة توافقهم لصديق. لا تستخدم نقاط أو قوائم.

ابدأ بمقدمة دافئة تذكر اسميهما وتشير للتوافق بينهما. ثم تحدث بشكل طبيعي عن الاهتمامات المشتركة التي تجمعهم، وكيف أن نمط حياتهم متناغم. اذكر تفاصيل محددة من إجاباتهم لتجعل التحليل شخصياً وحقيقياً. 

وضح كيف تكمل شخصياتهم بعضها البعض، حتى لو كانت هناك اختلافات، اعرضها كنقاط قوة وتوازن. في نهاية التحليل، اقترح نشاطين محددين يمكنهم الاستمتاع بهما معاً في الرياض بناءً على هواياتهم المشتركة.

اختم بجملة أو جملتين محفزة تشجعهم على الاستمرار في التعرف على بعضهم البعض.

مهم جداً:
- استخدم أسماءهم (${participantName} و${partnerName}) بشكل طبيعي في النص
- إذا كان أحد الأسماء بالإنجليزية، ترجمه للعربية إن أمكن (مثلاً: Ahmed → أحمد، Sara → سارة، Mohammad → محمد)
- لا تذكر أرقام المشاركين أبداً
- اكتب بلغة عربية فصحى سهلة وودية كأنك تتحدث مع صديق
