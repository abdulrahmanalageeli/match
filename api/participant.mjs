...
كل فعل وصفة وضمير في الرسالة يجب أن يطابق ${gender === "male" ? "ذكر" : gender === "female" ? "أنثى" : "الجنس"} تماماً (مذكر إذا كان ذكر، مؤنث إذا كانت أنثى). لا استثناء ولا تهاون هنا — هذا أهم من أي قاعدة أسلوبية أخرى.

قاعدة إلزامية ثانية — التركيز لا الحشو:
من بين المعلومات الست أعلاه، اختر عنصرين فقط — الأكثر تفرداً أو غرابة أو تناقضاً مع بعض — وابنِ الرسالة حولهما فقط. تجاهل الباقي كلياً. لا تحاول حشر كل المعلومات.

كيف توظّف المعلومات (تقنيات إلزامية، ليست اختيارية):
1. حوّل المعلومة إلى استعارة أو صورة — لا تذكرها كحقيقة مباشرة. (مثال: بدل "تحب الشطرنج" قل شي زي "أنت من النوع اللي يشوف النقلة الرابعة قبل لا يحرك الأولى")
2. خلي إيقاع الجملة نفسه يعكس ${music || "ذوقه"} — لو هادئ اكتب جمل بطيئة ومتأنية، لو حماسي اكتب جمل قصيرة وسريعة
3. لو دمجت عنصرين، ادمجهم في جملة وحدة غير متوقعة بدل جملتين منفصلتين
4. اجعل الإطراء يجي من زاوية غير مباشرة — كأن شخص ثاني بالفعالية بيلاحظ فيه الشي، مو انت اللي تمدحه

فكّر بصمت قبل الكتابة (لا تُخرج هذا التفكير):
- ما العنصرين الأكثر تفرداً بين معلومات ${firstName}؟
- وش الكلمة أو الإحساس اللي يحتاج يسمعه الحين بالضبط؟
- وش الصورة أو الاستعارة اللي تربط العنصرين بجملة وحدة؟

بنية الرسالة:
1. ابدأ باسم "${firstName}" بطريقة طبيعية غير مستهلكة
2. جملة أو جملتين توظّف العنصرين المختارين عبر استعارة/صورة غير مباشرة
3. جهّزه للفعالية بإشارة لتجربة تعارف ذكية ونقاشات — بدون شرح آلية المطابقة
4. اختم بسؤال فضولي حقيقي (ليس سؤالاً عاماً مثل "مستعد؟" أو "متحمس؟") — سؤال يصعب تجاهله ويخلق فضول فعلي

ممنوعات صارمة:
- ممنوع سرد أي معلومة بشكل مباشر أو حرفي
- ممنوع كلام عن الحب أو العاطفة أو الزواج
- ممنوع عبارات مستهلكة مثل "أهلاً وسهلاً" أو "مرحباً بك"
- ممنوع ذكر أنك AI أو ذكر أي تفاصيل تقنية عن آلية المطابقة
- ممنوع المواعظ أو النصائح المباشرة
- ممنوع تجاوز 100 كلمة تحت أي ظرف — عُدّ الكلمات قبل الإخراج
- ممنوع أي مقدمة قبل الرسالة أو علامات اقتباس حولها — أخرج نص الرسالة فقط، لا شيء غيره

أمثلة للمعايرة (توضح الفرق بين مباشر وذكي — لا تُخرجها، هي للفهم فقط):
سيئ (سرد مباشر): "يا أحمد، نعرف إنك تحب كرة القدم وتقضي الويكند مع الشباب، فرصتك الليلة تتعرف على ناس جدد."
جيد (استعارة غير مباشرة): "يا أحمد، بين صوت الملعب يوم السبت وهدوء يوم الأحد، أنت تعرف بالضبط متى تكون وسط الزحمة ومتى تنسحب منها بهدوء. الليلة الطاولة اللي بتجلس فيها فيها نفس التوازن. مين قال إن أول انطباع لازم يكون صاخب؟"`
