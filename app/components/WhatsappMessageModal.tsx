...
export default function WhatsappMessageModal({ participant, isOpen, onClose }: WhatsappMessageModalProps) {
  ...
  const [templateType, setTemplateType] = useState<'match' | 'early-match' | 'event-info' | 'faq-payment' | 'faq-location' | 'faq-timing' | 'reminder' | 'payment-reminder'>('match');
