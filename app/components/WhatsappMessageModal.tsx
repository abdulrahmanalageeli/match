...
export default function WhatsappMessageModal({ participant, isOpen, onClose }: WhatsappMessageModalProps) {
  ...
  const [urgencyLevel, setUrgencyLevel] = useState<'normal' | 'semi-urgent' | 'urgent' | 'ultra-urgent'>('normal');
            ...
            <div className="bg-slate-800 border border-slate-600 rounded-lg p-4">
              ...
              <div className="space-y-3">
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <div className="text-xs mt-1 opacity-80">مهلة 12 ساعة للرد - نبرة مهمة</div>
                    </div>
                    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ml-3 ${
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <div className="font-medium">🚨 رسالة عاجلة</div>
                      <div className="text-xs mt-1 opacity-80">مهلة 6 ساعات للرد - نبرة عاجلة</div>
                    </div>
                    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ml-3 ${
                ...
                {/* Ultra-urgent - 1 hour */}
                <button
                  onClick={() => setUrgencyLevel('ultra-urgent')}
                  className={`w-full p-3 rounded-lg text-right transition-all ${
                    urgencyLevel === 'ultra-urgent'
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ml-3 ${
                      urgencyLevel === 'ultra-urgent' ? 'border-white' : 'border-slate-400'
                    }`}>
                      {urgencyLevel === 'ultra-urgent' && <div className="w-3 h-3 rounded-full bg-white"></div>}
                    </div>
                  </div>
                </button>
              </div>
