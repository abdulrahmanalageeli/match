...
export default function WhatsappMessageModal({ participant, isOpen, onClose }: WhatsappMessageModalProps) {
  ...
  const [templateType, setTemplateType] = useState<'match' | 'early-match' | 'event-info' | 'faq-payment' | 'faq-location' | 'faq-timing' | 'reminder' | 'payment-reminder' | 'partner-info'>('match');
  ...
  const message = useMemo(() => {
    ...
    switch (templateType) {
      ...
      case 'partner-info':
        return `*التوافق الأعمى* 🔒\n\nالسلام عليكم *${name}*،\n\n🤝 *سياسة الخصوصية ومعلومات الشريك*\n\n❓ *هل يمكنكم مشاركة معلومات عن شريكي؟*\n\n🔒 نعتذر، لا يمكننا مشاركة أي معلومات شخصية عن شريكك قبل اللقاء. هذا جزء أساسي من تجربة "التوافق الأعمى".\n\n✨ *فلسفة التوافق الأعمى:*\n\nنظامنا يركز على التوافق الشخصي والفكري بغض النظر عن:\n• الهوية الشخصية\n• الجنسية أو الأصل\n• المظهر الخارجي\n• الخلفية الاجتماعية\n• أي معلومات تعريفية أخرى\n\n🎯 *ما نضمنه لكم:*\n\n✅ شريكك من نفس الفئة العمرية (فارق عمري محدود)\n✅ توافق شخصي عالي بناءً على:\n   • نوع الشخصية (MBTI)\n   • أسلوب التواصل\n   • القيم والاهتمامات\n   • الأهداف الحياتية\n   • التوافق الفكري\n\n✅ احترام تفضيلاتك (نفس الجنس/جنس مختلف)\n✅ بيئة آمنة ومحترمة\n\n💡 *لماذا نحافظ على السرية؟*\n\n1️⃣ *تجربة حقيقية:* اللقاء بدون أحكام مسبقة\n2️⃣ *تركيز على الجوهر:* التعرف على الشخصية الحقيقية\n3️⃣ *فرصة عادلة:* الجميع يبدأ من نقطة متساوية\n4️⃣ *حماية الخصوصية:* احترام خصوصية جميع المشاركين\n\n🌟 *الفائدة من هذا النهج:*\n\nالدراسات تثبت أن اللقاءات "العمياء" تؤدي إلى:\n• تواصل أعمق وأكثر صدقاً\n• تقييم أفضل للتوافق الحقيقي\n• علاقات أقوى وأطول أمداً\n• تجربة أكثر إثارة ومتعة\n\n❓ *أسئلة شائعة:*\n\n**س: هل سأعرف اسم شريكي؟**\nج: نعم، خلال اللقاء ستتعرفون على بعضكم بشكل طبيعي.\n\n**س: هل الشريك من نفس المدينة؟**\nج: جميع المشاركين في الفعالية من نفس المنطقة.\n\n**س: هل يمكنني معرفة جنسية الشريك؟**\nج: نركز على التوافق الشخصي بغض النظر عن الجنسية.\n\n**س: ماذا لو لم يعجبني الشريك؟**\nج: لا يوجد أي التزام بعد اللقاء. التجربة للتعارف فقط.\n\n🎁 *ثقوا بالنظام:*\n\nخوارزميتنا حللت شخصيتكم بعمق واختارت لكم شريكاً متوافقاً بنسبة عالية. امنحوا التجربة فرصة!\n\n📍 *تفاصيل الفعالية:*\nالمكان: كوفي بلانيت - الدور الثاني\nالعنوان: https://maps.app.goo.gl/CYsyK9M5mxXMNo9YA\n\n📅 التاريخ: السبت 1 نوفمبر 2024\n🕰️ الوقت: 7:30 مساءً\n\nرقم المشارك: *${assignedNumber}*\n\n🔗 رابط حسابك:\nhttps://match-omega.vercel.app/welcome?token=${secureToken}\n\n💬 *لأي استفسارات إضافية، نحن هنا للمساعدة!*\n\nفريق التوافق الأعمى`;
