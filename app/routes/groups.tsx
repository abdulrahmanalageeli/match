...
const games: Game[] = [
  ...
  },
  {
    ...
    description: "Vote in person or privately by passing one phone, then discuss everyday habits",
    descriptionAr: "٣٠ موقف: صوّتوا حضوريًا أو بسرّية بتمرير الهاتف، واسمعوا أسباب بعض.",
    energyAr: "متوازن",
