...
// ماذا تفعل لو؟ – سيناريوهات أعمق (مناسبة للتقاليد السعودية وغير موجهة للتعارف)
const whatWouldYouDoScenarios: string[] = [
  "ماذا تفعل لو كان الصمت يحمي فردًا، لكن قول الحقيقة يحمي الجماعة؟ أيهما تقدّم؟ ولماذا؟",
  "ماذا تفعل لو حصلت على منفعة ليست من حقك بسبب خطأ إداري ولم ينتبه أحد؟ ما قرارك؟ وما معيارك؟",
  "ماذا تفعل لو طُلب منك تنفيذ توجيه ترى أنه يفتقد للعدل لكنه قانوني؟ كيف توفّق بين الطاعة والإنصاف؟",
  "ماذا تفعل لو أخطأتَ في قرار أثّر على مجموعة، والاعتراف سيحرجك علنًا لكنه يصحّح المسار؟ ما الذي ستفعله؟",
  "ماذا تفعل لو تعارضت قيمة \"الستر\" مع واجب الإبلاغ لحماية الآخرين؟ أين تضع الحدّ؟",
  "ماذا تفعل لو كان تصحيح معلومة علنًا سيجرح شخصًا، بينما التصحيح الخاص قد لا يصل للجميع؟ كيف تختار الأسلوب؟",
  "ماذا تفعل لو لاحظت انحيازًا غير مقصود ضد فئة في فريقك؟ ما أول خطوة عملية لتصحيح العدالة؟",
  "ماذا تفعل لو كان لديك تضارب مصالح خفي في مشروعٍ تُقيّمه؟ كيف تتصرف بشفافية دون تعطيل العمل؟",
  "ماذا تفعل لو تعيّن عليك توزيع موارد محدودة بعدل بين مستحقين كُثر؟ ما معيارك؟ ولماذا؟",
  "ماذا تفعل لو رأيت قياديًا يحسم مسألة بسرعة على حساب التبيّن؟ كيف تعترض باحترام وتحفظ أثرًا؟",
  "ماذا تفعل لو تعارضت كرامة شخص مع مزحةٍ تنتشر في المجموعة؟ كيف توقفها بأدب وتحفظ الودّ؟",
  "ماذا تفعل لو لاحظت أن خوفك من الفشل يوجّه قراراتك دون وعي؟ ما تجربة صغيرة تختبر بها شجاعتك؟",
  "ماذا تفعل لو اكتشفت أثرًا سلبيًا لقرارك بعد أشهر؟ كيف تعالج الأثر المتراكم وتتعلم منه؟",
  "ماذا تفعل لو أنقذك أحد من مأزق ولم يُرِد أن يُذكر فضله؟ كيف ترد الجميل مع حفظ نيته؟",
  "ماذا تفعل لو رأيت اجتهادًا صادقًا نتج عنه خطأ ظاهر؟ كيف توازن بين الإنصاف والتعلم؟",
  "ماذا تفعل لو طُلب منك رأيٌ حساس سيغيّر مسار قرار جماعي؟ كيف تضمن النزاهة ووضوح المعايير؟",
  "ماذا تفعل لو شعرت أن سرعة الإنجاز بدأت تُضعف جودة العمل والقيم؟ ما ثلاثة ضوابط تعيد بها التوازن؟",
  "ماذا تفعل لو رأيت \"تطبيعًا للخطأ الصغير\" بحجة المصلحة؟ كيف توقف النزول التدريجي للمعيار؟",
  "ماذا تفعل لو كان بين يديك سرّ قد يضر صاحبه إن كُشف، لكنه ينقذ آخرين من ضررٍ أعظم؟ كيف تقدّر المآلات؟",
  "ماذا تفعل لو خُيّرت بين إنصافٍ بارد وعدلٍ دافئ (قانون مقابل رحمة منظّمة)؟ متى ترجّح كل خيار؟ ولماذا؟",
  "ماذا تفعل لو أصبحت قدوةً للآخرين دون قصد؟ ما السلوك الذي ستضبطه أولًا لأن أثره مضاعف؟",
  "ماذا تفعل لو تعارضت مصلحة قريبة مع سمعة الفريق على المدى البعيد؟ كيف تتخذ قرارًا يحفظ الأثر؟",
  "ماذا تفعل لو لاحظت أن \"نيّة حسنة\" تُستخدم لتبرير تقصيرٍ متكرر؟ كيف تُقيم النيّة مع النتيجة بإنصاف؟",
  "ماذا تفعل لو احتجت أن تختار بين إنقاذ موقفٍ الآن أو بناء نظام يمنع تكراره لاحقًا؟ أيهما تقدّم؟ ولماذا؟"
];
