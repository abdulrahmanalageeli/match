...
export default function WelcomePage() {
  ...
  const round3Questions = [
    ...
    // Goal: Low stakes, fun, immediate personality indicators.
    {
      ...
      question: `لو بفتش جوالك الحين، وش أكثر تطبيق تستهلك فيه وقتك؟ وهل أنت فخور بهالشيء ولا تحاول تخفف؟`,
      level: 0,
    ...
    {
      title: `سفرة الأحلام`,
      question: `تخيل جتك تذكرة مفتوحة لأي مكان بالعالم بكرة، بس بشرط تروح "لحالك". وين بتختار تروح؟ وليش؟`,
      level: 0,
      levelTitle: `اتصال سريع`,
      levelIcon: `Zap`
    },
    {
      title: `أكلة الطفولة`,
      question: `وش الأكلة اللي مجرد ما تشم ريحتها ترجعك فوراً لبيت أهلكم أو لأيام الطفولة؟`,
      level: 0,
      levelTitle: `اتصال سريع`,
      levelIcon: `Zap`
    },
    {
      title: `القوة الخارقة`,
      question: `لو تقدر تختار قوة خارقة وحدة (تطير، تقرأ الأفكار، تختفي، ترجع بالزمن)، وش تختار؟ والأهم: وش أول شي بتسويه فيها؟`,
      level: 0,
      levelTitle: `اتصال سريع`,
      levelIcon: `Zap`
    },
    {
      title: `مود الصباح`,
      question: `أنت من فريق "أصحى رايق وأشرب قهوتي بهدوء" ولا فريق "غيبوبة لين الظهر ومالي خلق أحد"؟`,
      level: 0,
      levelTitle: `اتصال سريع`,
      levelIcon: `Zap`
    },
    {
      title: `رأي غير شعبي`,
      question: `عطنا (Unpopular Opinion) عندك.. رأي تؤمن فيه بقوة بس أغلب الناس تعارضك عليه؟`,
      level: 0,
      levelTitle: `اتصال سريع`,
      levelIcon: `Zap`
    },
    {
      title: `المشتريات الغريبة`,
      question: `وش أغبى أو أغرب شيء شريته أونلاين وتحسفت عليه، أو طلع شيء رهيب ما توقعته؟`,
      level: 0,
      levelTitle: `اتصال سريع`,
      levelIcon: `Zap`
    },
    ...
    {
      title: `مهارة المصفوفة`,
      question: `لو تقدر تتعلم مهارة جديدة في ثانية وحدة (زي فيلم Matrix) وتصير محترف فيها، وش بتكون هالمهارة؟`,
      level: 1,
      levelTitle: `المستوى الأول: الشرارة - لكسر الحاجز`,
      levelIcon: `Flame`
    },
    {
      title: `قائمة الإمتنان`,
      question: `بعيداً عن الأساسيات (الأهل والصحة).. وش الشيء "الصغير" أو التافه اللي ممتن لوجوده في حياتك اليومية؟`,
      level: 1,
      levelTitle: `المستوى الأول: الشرارة - لكسر الحاجز`,
      levelIcon: `Flame`
    },
    {
      title: `الكوميديا الشخصية`,
      question: `وش نوع المقاطع أو المواقف اللي تضحكك من قلب؟ يعني ضحك يخلي دموعك تنزل؟`,
      level: 1,
      levelTitle: `المستوى الأول: الشرارة - لكسر الحاجز`,
      levelIcon: `Flame`
    },
    {
      title: `الضيف المثالي`,
      question: `لو بتقيم عشاء وتعزم ٣ شخصيات (حقيقيين أو خياليين، أحياء أو أموات)، مين بتختار؟ ووش بتسولفون عنه؟`,
      level: 1,
      levelTitle: `المستوى الأول: الشرارة - لكسر الحاجز`,
      levelIcon: `Flame`
    },
    ...
    {
      title: `رسالة للماضي`,
      question: `لو تقدر ترسل رسالة صوتية مدتها ١٠ ثواني لنفسك قبل ٥ سنوات.. وش بتقول؟ (تحذير، نصيحة، ولا تطمين)؟`,
      level: 2,
    ...
    {
      title: `مفهوم النجاح`,
      question: `الكل يبي ينجح، بس تعريف النجاح يختلف. متى تقدر تقول عن نفسك "أنا نجحت"؟ هل هو رقم في البنك، راحة بال، ولا أثر تتركه؟`,
      level: 2,
      levelTitle: `المستوى الثاني: الجوهر - فهم القيم`,
      levelIcon: `Compass`
    },
    {
      title: `لغة الاعتذار`,
      question: `في الخلافات، هل أنت الشخص اللي يبادر بالاعتذار عشان يمشي الحياة، ولا الشخص اللي لازم يثبت وجهة نظره أول؟ وكيف تشوف هذا يأثر على علاقاتك؟`,
      level: 2,
      levelTitle: `المستوى الثاني: الجوهر - فهم القيم`,
      levelIcon: `Compass`
    },
    {
      title: `الثقة والحدس`,
      question: `هل تعتمد في قراراتك المصيرية على "المنطق والتحليل" ولا تمشي وراء "إحساسك وحدسك"؟ ومتى خذلك واحد منهم؟`,
      level: 2,
      levelTitle: `المستوى الثاني: الجوهر - فهم القيم`,
      levelIcon: `Compass`
    },
    {
      title: `مصدر الأمان`,
      question: `وش المكان (أو الحالة) اللي تحس فيه إنك "في بيتك" وتشعر بأمان تام وتقدر تكون نفسك ١٠٠٪ بدون أقنعة؟`,
      level: 2,
      levelTitle: `المستوى الثاني: الجوهر - فهم القيم`,
      levelIcon: `Compass`
    },
    {
      title: `الخوف المحفز`,
      question: `وش أكبر مخاوفك اللي تحس إنها، بطريقة غريبة، هي اللي تدفعك للأمام وتخليك تنجز؟`,
      level: 2,
      levelTitle: `المستوى الثاني: الجوهر - فهم القيم`,
      levelIcon: `Compass`
    },
    ...
    {
      title: `المخاطرة الكبرى`,
      question: `احكِ لنا عن أكبر "مخاطرة" أخذتها في حياتك (سواء في شغل أو علاقة). هل ندمت عليها ولا كانت تستاهل؟`,
      level: 3,
    ...
    {
      title: `اللقاء العابر`,
      question: `هل قد قابلت شخص غريب، جمعتكم صدفة لدقائق أو ساعات، بس قال كلمة أو سوا موقف ما نسيته أبدًا؟`,
      level: 3,
      levelTitle: `المستوى الثالث: مشاركة التجارب`,
      levelIcon: `Sparkles`
    },
    {
      title: `لحظة الإدراك`,
      question: `وش العادة أو الطبع اللي كان فيك واكتشفت مؤخرًا إنه "سام" (Toxic) وقررت تشتغل على تغييره؟`,
      level: 3,
      levelTitle: `المستوى الثالث: مشاركة التجارب`,
      levelIcon: `Sparkles`
    },
    {
      title: `الطفل الداخلي`,
      question: `وش الشيء اللي كنت تحلم فيه وأنت طفل، والحين يوم كبرت استوعبت إنه ماله داعي أو تغيرت نظرتك له تماماً؟`,
      level: 3,
      levelTitle: `المستوى الثالث: مشاركة التجارب`,
      levelIcon: `Sparkles`
    },
    {
      title: `أصعب وداع`,
      question: `مو شرط أشخاص.. ممكن وداع لمكان، وظيفة، أو مرحلة عمرية. وش أصعب شيء اضطريت تتركه ورا ظهرك عشان تكمل طريقك؟`,
      level: 3,
      levelTitle: `المستوى الثالث: مشاركة التجارب`,
      levelIcon: `Sparkles`
    },
    {
      title: `الدعم الخفي`,
      question: `من الشخص اللي وقف معك في وقت صعب بدون ما يطلب مقابل، وتحس إنك ما شكرته بالشكل الكافي؟`,
      level: 3,
      levelTitle: `المستوى الثالث: مشاركة التجارب`,
      levelIcon: `Sparkles`
    },
    ...
    // Goal: Testing compatibility and wrapping up the dynamic.
    {
      ...
      question: `لو تعطل فينا المصعد الحين وحنا مع بعض لمدة ساعتين.. وش بيكون دورك؟ (اللي يهدّي الوضع، اللي يخاف، ولا اللي ينكت)؟ ووش تتوقع دوري أنا؟`,
      level: 4,
      levelTitle: `المستوى الرابع: "ماذا لو؟" - استكشاف السيناريوهات`,
      levelIcon: `Handshake`
    },
    {
      title: `الحقيقة أم اللطف`,
      question: `لو سألتك عن رأيك في شيء يخصني (لبس أو فكرة) وكان رأيك سلبي، هل بتجاملني عشان مشاعري ولا بتعطيني الحقيقة "كاش"؟ ووش تفضل إنت لو كنت مكاني؟`,
      level: 4,
      levelTitle: `المستوى الرابع: "ماذا لو؟" - استكشاف السيناريوهات`,
      levelIcon: `Handshake`
    },
    {
      title: `لو ربحنا`,
      question: `لو ربحنا مبلغ خيالي بشرط نصرفه في ٢٤ ساعة وبشكل مشترك.. وش أول شيء نتفق نسويه؟`,
      level: 4,
      levelTitle: `المستوى الرابع: "ماذا لو؟" - استكشاف السيناريوهات`,
      levelIcon: `Handshake`
    },
    {
      title: `عنوان اللقاء`,
      question: `بعد ما عرفتني شوي من خلال هالأسئلة.. لو بتعطي "عنوان" لكتاب يحكي قصة لقائنا اليوم، وش بيكون العنوان؟`,
      level: 4,
      levelTitle: `المستوى الرابع: "ماذا لو؟" - استكشاف السيناريوهات`,
      levelIcon: `Handshake`
    }
  ...
  */
  ...
  // Vibe Questions Completion Popup overlay will be rendered within the main page structure

  // Survey Recovery Popup overlay will be rendered within the main page structure

  // Survey Completion Popup overlay will be rendered within the main page structure
  ...
  return (<>
    ...
    <div
      ...
      {/* Vibe Questions Completion Popup (overlay within main page) */}
      {showVibeCompletionPopup && Object.keys(incompleteVibeQuestions).length > 0 && (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50 p-4" dir="rtl">
          <div className={`max-w-2xl w-full max-h-[90vh] rounded-2xl shadow-2xl border-2 ${dark ? "bg-slate-800/95 border-slate-600" : "bg-white/95 border-gray-200"} flex flex-col`}>
            <div className="p-6 overflow-y-auto">
              <div className="space-y-4">
                ...
                {Object.entries(incompleteVibeQuestions).map(([key, info]) => {
                  ...
                  return (
                    <div key={key} className={`p-4 rounded-xl border ${dark ? "bg-purple-500/10 border-purple-400/30" : "bg-purple-50 border-purple-200"}`}>
                      <p className={`text-sm font-medium mb-2 ${dark ? "text-purple-300" : "text-purple-700"}`}>{info.label}</p>
                      <textarea
                      ...
                      <div className="flex justify-between items-center mt-2 text-xs">
                        <span className={`font-medium ${isBelowMinimum ? (dark ? 'text-yellow-400' : 'text-yellow-600') : (dark ? 'text-green-400' : 'text-green-600')}`}>
                          {currentLength}/{info.max} حرف (الحد الأدنى: {info.required})
                        </span>
                        {isBelowMinimum ? (
                          <span className={`font-medium ${dark ? 'text-yellow-400' : 'text-yellow-600'}`}>يحتاج {remaining} حرف إضافي</span>
                        ) : (
                          <span className={`font-medium ${dark ? 'text-green-400' : 'text-green-600'}`}>✓ مكتمل</span>
                        )}
                      </div>
                    </div>
                  )
                ...
                <div className="flex gap-3 pt-4">
                  <button
                    onClick={() => { setShowVibeCompletionPopup(false); setIncompleteVibeQuestions({}); setVibeAnswers({}); }}
                    disabled={vibeLoading}
                    className={`flex-1 px-4 py-3 rounded-xl border transition-all duration-300 ${dark ? "bg-slate-700/50 border-slate-600 text-slate-300 hover:bg-slate-600/50" : "bg-gray-100 border-gray-300 text-gray-700 hover:bg-gray-200"} disabled:opacity-50`}
                  >إغلاق</button>
                  <button
                  ...
                  >
                    {vibeLoading ? (<><div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin"></div>جاري الحفظ...</>) : (<><CheckCircle className="w-4 h-4" />حفظ التحديثات</>)}
                  </button>
                </div>
              </div>
            </div>
      ...
      {/* Survey Recovery Popup (overlay within main page) */}
      {showSurveyRecoveryPopup && surveyRecoveryInfo && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4" dir="rtl">
          <div className={`max-w-md w-full max-h-[90vh] rounded-2xl shadow-2xl border-2 ${dark ? "bg-slate-800/90 border-slate-600" : "bg-white/90 border-gray-200"} flex flex-col`}>
            <div className="p-6 overflow-y-auto">
              <h2 className={`text-xl font-bold mb-2 ${dark ? 'text-slate-100' : 'text-gray-800'}`}>حدث خلل تقني في بياناتك</h2>
              ...
              <div className={`mt-4 p-3 rounded-lg ${dark ? 'bg-yellow-500/10 text-yellow-300 border border-yellow-500/30' : 'bg-yellow-50 text-yellow-700 border border-yellow-200'}`}>
                <div className="text-sm">رقم المشارك: <span className="font-bold">#{surveyRecoveryInfo.assigned_number}</span></div>
              </div>
              <div className="flex gap-3 pt-5">
                <button
                  onClick={() => { setShowSurveyRecoveryPopup(false) }}
                  className={`flex-1 px-4 py-3 rounded-xl border transition-all duration-300 ${dark ? "bg-slate-700/50 border-slate-600 text-slate-300 hover:bg-slate-600/50" : "bg-gray-100 border-gray-300 text-gray-700 hover:bg-gray-200"}`}
                >لاحقاً</button>
                <button
                  onClick={() => {
                    const token = surveyRecoveryInfo.secure_token || secureToken || resultToken || returningPlayerToken || (typeof window !== 'undefined' && (localStorage.getItem('blindmatch_result_token') || localStorage.getItem('blindmatch_returning_token')));
                    if (token) {
                ...
                >إعادة تعبئة الاستبيان الآن</button>
              </div>
            </div>
          </div>
        </div>
