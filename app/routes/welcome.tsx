                      ...
                      <div className="mt-4">
                        ...
                        {currentRound === 1 && (
                          <div className="flex flex-col items-center justify-center py-8">
                            ...
                            <h2 className="mt-6 text-2xl font-extrabold bg-gradient-to-r from-cyan-500 to-blue-600 bg-clip-text text-transparent drop-shadow">
                              بانتظار المنظّم
                            </h2>
                            <p className="mt-2 text-lg font-medium text-cyan-700 animate-fade-in">
                              سيتم إخبارك عندما يبدأ المنظّم الجولة التالية
                            </p>
