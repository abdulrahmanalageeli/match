...
export default function WelcomePage() {
  ...
  const round1Questions = [
    ...
    // Level 3: Sharing Experiences - مشاركة التجارب 💫
    {
      ...
      question: "صف موقف حسيت فيه إن الشخص قدامك «فهمك وشايفك» على حقيقتك. إيش سوى أو قال عشان تحسّ بهذا الاحتواء الحقيقي؟",
      level: 3,
    ...
    {
      title: "معضلة التخطيط",
      question: "تخيّل إنكم تخططون لرحلة نهاية أسبوع سوا. واحد يحب يكون كل شي منظم وجداول، والثاني يحب العفوية دون تخطيط. كيف تتفقون على ترتيب وسط يرضيكم كلكم؟",
      level: 4,
      levelTitle: "المستوى الرابع: \"ماذا لو؟\" - استكشاف السيناريوهات",
      levelEmoji: "🤝"
    },
    ...
    {
      title: "حياة موازية",
      question: "تخيّل لو كنت عايش حياة ثانية في عالم موازٍ: كيف تتصور حياتك هناك؟ إيش الفروقات عن الحين؟",
      level: 4,
      levelTitle: "المستوى الرابع: \"ماذا لو؟\" - استكشاف السيناريوهات",
      levelEmoji: "🤝"
    },
    {
      title: "مقايضة القيم",
      question: "لو اضطرّيت تختار تتخلى عن قيمة أساسية لك وتحل محلها قيمة ثانية جديدة (مثلاً الحرية مقابل الأمان)، أي قيمة ممكن تبدّلها وليش؟",
      level: 4,
      levelTitle: "المستوى الرابع: \"ماذا لو؟\" - استكشاف السيناريوهات",
      levelEmoji: "🤝"
    },
