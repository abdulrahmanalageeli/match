          ...
          <div className="max-w-4xl w-full">
            ...
            {showRegistrationContent && (
              <>
                ...
                {/* Header Section */}
                <div className="text-center mb-4 sm:mb-5 pt-8 sm:pt-12 animate-in slide-in-from-bottom-4 duration-1000">
                ...
                <div className={`max-w-4xl mx-auto -mt-2 mb-2 rounded-2xl border overflow-hidden ${dark ? "bg-slate-900/80 border-slate-700/50 shadow-lg shadow-black/30" : "bg-gray-900/80 border-gray-700/50 shadow-lg"}`}>
