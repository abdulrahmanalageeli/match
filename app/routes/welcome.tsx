...
export default function WelcomePage() {
  ...
  // Forgot token OTP recovery state
                  ...
                  <div className="mx-auto mb-2 max-w-3xl px-3 sm:px-5">
                    <div className="flex items-center gap-2 px-3 py-2 text-right text-amber-100/70">
                      ...
                      <span className="text-[11px] font-medium leading-5 sm:text-xs">
                        {tutorialChoiceOnly
                          ? 'ترتيبك سري: أول لقاءين يقدّمان أقوى الخيارات الفردية الممكنة، والثالث يوازن كل الخيارات المتبقية.'
                    ...
                    <div id="blindmatch-how-it-works" role="tabpanel" aria-labelledby={tutorialChoiceOnly ? 'choice-only-tutorial-tab' : 'classic-tutorial-tab'} aria-hidden={!isHowItWorksOpen} className="blindmatch-explainer-content">
                      ...
                      <div className="px-3 pb-5 pt-5 sm:px-6 sm:pb-7">
                        <div className="blindmatch-explainer-hero relative overflow-hidden rounded-[1.5rem] border border-white/[0.08] bg-gradient-to-br from-violet-500/[0.09] via-transparent to-cyan-400/[0.08] p-4 sm:p-6">
                          ...
                          <div className="relative text-right">
                            ...
                            <p className="mt-2 max-w-3xl text-xs leading-6 text-slate-400 sm:text-sm">
                              {tutorialChoiceOnly
                                ? 'تقابل ثلاث مجموعات مختلفة من ستة أشخاص، وترتّب من قابلتهم سراً. بعدها تعيش ثلاثة لقاءات فردية مع ثلاثة أشخاص مختلفين.'
                        ...
                        <div className="blindmatch-explainer-timeline relative mt-6 space-y-3 before:absolute before:bottom-7 before:right-[15px] before:top-7 before:w-px before:bg-gradient-to-b before:from-blue-400/40 before:via-pink-400/30 before:to-violet-400/40 sm:before:right-[19px]">
                          {(tutorialChoiceOnly ? [
                            {
                              number: "01", Icon: Users, tone: "text-blue-200 bg-blue-400/10 ring-blue-300/20", title: "ثلاث جولات جماعية — ثلاث مجموعات مختلفة", meta: "6 أشخاص في كل مجموعة", body: "تذهب إلى رقم طاولتك في كل جولة وتتعرف على مجموعة مختلفة. مع 42 مشاركاً تكون هناك 7 طاولات، وتتعرّف على 15 شخصاً مختلفاً قبل اللقاءات الفردية.",
                            },
                            {
                            ...
                            {
                              number: "03", Icon: Coffee, tone: "text-orange-200 bg-orange-400/10 ring-orange-300/20", title: "استراحة وحساب الاختيار الأول", meta: "أولوية الاختيار الفردي", body: "يبدأ النظام بأقوى الرتب المتبادلة ويختار أقوى أزواج يمكن معها إكمال الجولة. لا تدخل درجات الاستبيان أو خوارزمية التوافق في اختيار الشريك.",
                            },
                            {
                            ...
                            {
                              number: "05", Icon: Heart, tone: "text-purple-200 bg-purple-400/10 ring-purple-300/20", title: "اللقاء الفردي الثاني", meta: "الاختيار الثاني", body: "يطبّق النظام أولوية الاختيار الفردي مرة أخرى بعد استبعاد شريك اللقاء الأول، ثم تسجّل تقييم اللقاء بالطريقة نفسها.",
                            },
                            {
                              number: "06", Icon: Heart, tone: "text-violet-200 bg-violet-400/10 ring-violet-300/20", title: "اللقاء الفردي الثالث", meta: "أفضل توزيع شامل", body: "يختار النظام أفضل خطة شاملة من الرتب المتبادلة المتبقية بعد استبعاد شريكي اللقاءين السابقين، لذلك تقابل شخصاً ثالثاً مختلفاً.",
                            },
                            {
                        ...
                        <div className="mt-6 grid gap-3 sm:grid-cols-2">
                          ...
                          <div className="rounded-[1.35rem] border border-pink-400/15 bg-pink-400/[0.045] p-3 text-right sm:col-span-2 sm:p-4">
                            ...
                            <p className="mt-2 text-xs leading-6 text-slate-400">اللقاءان الأول والثاني يحافظان على أولوية أقوى الأزواج المتبادلة الممكنة. اللقاء الثالث يختار أفضل توزيع شامل متبقٍ. بعد كل لقاء يُستبعد شريكه، لذلك تحصل على ثلاثة شركاء مختلفين من دون استخدام درجات التوافق.</p>
                          </div>
                          ) : (
                          <>
