...
export default function WelcomePage() {
  ...
  const round1Questions = [
    ...
    {
      title: "أول لمعة",
      question: "لو نبدأ من أول لحظة.. وش الشيء البسيط اللي يخليك تحس بالراحة أو الانسجام على طول مع شخص؟",
      level: 0,
    ...
    },
    {
      ...
      question: "لما تحس بالضغط أو تواجه تحدي، هل تلجأ للناس عشان تاخذ دعمهم ورأيهم؟",
      level: 2,
      levelTitle: "المستوى الثاني: الجوهر - فهم القيم",
      levelEmoji: "🧭"
    },
    ...
    {
      title: "المعنى الخفي",
      question: "وش الشيء الصغير اللي يعطي حياتك معنى أو يذكرك إنك في الطريق الصح حتى لو ما انتبه له أحد؟",
      level: 2,
      levelTitle: "المستوى الثاني: الجوهر - فهم القيم",
      levelEmoji: "🧭"
    },
    ...
    {
      title: "لو توقف الزمن",
      question: "تخيل إن عندك يوم واحد يتوقف فيه الزمن لكل شيء إلا أنت. وش أول شي بتسويه وليش؟",
      level: 4,
      levelTitle: "المستوى الرابع: \"ماذا لو؟\" - استكشاف السيناريوهات",
      levelEmoji: "🤝"
    },
