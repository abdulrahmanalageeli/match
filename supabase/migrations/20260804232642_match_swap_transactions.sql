...
begin
  ...
  insert into public.match_results (
    ...
    disagreement_style_score, current_life_overlap_score,
    similarity_preference_score, attachment_pace_score,
  ...
  select
    ...
    coalesce((item ->> 'disagreement_style_score')::numeric, 0),
    coalesce((item ->> 'current_life_overlap_score')::numeric, 0),
    coalesce((item ->> 'similarity_preference_score')::numeric, 0),
    coalesce((item ->> 'attachment_pace_score')::numeric, 0),
