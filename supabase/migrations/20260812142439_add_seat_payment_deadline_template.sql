...
values (
  ...
  'seat_payment_deadline',
  'Seat allocation payment deadline; variable 2 is generated exactly 15 minutes after send.',
  ...
  '[{"key":"1","label":"Participant name"},{"key":"2","label":"Payment deadline (15 minutes after send, Asia/Riyadh)"}]'::jsonb,
